...
class Simulation:
    ...
    def scint_condition(self, corner_pt, scint_radius, scint_num): # removing memory
        ...
        return np.sqrt(radius_squared) < self.T1_radius # retrun T1 otherwise T4
    ...
    # DISTANCE 2-DIM CIRCLE WITH LINE SEGMENT V2
    # t = -D . ∆ ± √(D . ∆)^2 - |D|^2(|∆|^2 - R^2)
    #     over |D|^2
    # ARGUMENTS : # 3d directional vector, 3d point, center of scintillator, radius of scintillator, use corner circle boolean
    def distance_circle(self, u, o, center, radius, quadrant=False):
